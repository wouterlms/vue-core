...
<template>
  <ComboboxItem
    :value="props.value"
    class="relative flex cursor-pointer items-center gap-x-3 rounded-lg p-3 text-muted-foreground duration-100 data-[highlighted]:bg-muted-background data-[highlighted]:text-foreground"
  >
    <svg
      width="56"
      height="56"
